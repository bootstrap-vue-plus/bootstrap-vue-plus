...
import { useGlobalConfig, useLocale } from '@bootstrap-vue-plus/hooks'
import Chinese from '@bootstrap-vue-plus/locale/lang/zh-cn'
import English from '@bootstrap-vue-plus/locale/lang/en'
import { ElButton, ElMessage } from '@bootstrap-vue-plus/components'
import { rAF } from '@bootstrap-vue-plus/test-utils/tick'
  ...
  describe('locale-provider', () => {
    ...
    it('should provide locale properly', async () => {
      expect(wrapper.find('.current-locale').text()).toBe(
        English.bv.popconfirm.confirmButtonText
      )
      expect(wrapper.find('.opposite-locale').text()).toBe(
        Chinese.bv.popconfirm.confirmButtonText
      )
    })
