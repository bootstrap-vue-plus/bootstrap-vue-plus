...
export const WINDOW = (HAS_WINDOW_SUPPORT ? window : {}) as any
export const DOCUMENT = (HAS_DOCUMENT_SUPPORT ? document : {}) as any
export const NAVIGATOR = (HAS_NAVIGATOR_SUPPORT ? navigator : {}) as any
